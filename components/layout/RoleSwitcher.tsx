  ...
  return (
    <div className={cn('relative', className)}>
      <button
        ...
        title="Switch between Administrator and Barbers"
      >
        <ArrowRightLeft className="w-3.5 h-3.5 text-amber-400" />
        <span>Current role:</span>
        <span className="font-semibold text-amber-400">
          {role === 'ADMIN' ? 'Admin' : `Barber: ${user?.name || 'Staff'}`}
        </span>
      </button>
            ...
            <div className="mt-2 space-y-1">
              ...
              >
                ...
                <div className="flex-1">
                  <div className="font-semibold">Global Administrator</div>
                  <div className="text-[10px] text-zinc-400">
                    Full access to finances, barbers and services
                  </div>
                </div>
              </button>
              ...
              {barbers.length === 0 ? (
                ...
                >
                  ...
                  <div>
                    <div className="font-semibold">Barber #1 (Default)</div>
                    <div className="text-[10px] text-zinc-400">Personal schedule and metrics</div>
                  </div>
                </button>
              ) : (
                barbers.map((b) => (
                  ...
                  >
                    ...
                    <div className="flex-1 overflow-hidden">
                      ...
                      <div className="text-[10px] text-zinc-400">
                        {b.phone || `ID: #${b.id}`} • {b.active ? 'Active' : 'Inactive'}
                      </div>
                    </div>
                  </button>
                ))
